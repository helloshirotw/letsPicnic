...
class APIService {
    ...
    // Fetch 15 parks
    func fetchPark(offset: Int, completionHandler: @escaping ([TaipeiPark]?, Error?) -> ()) {
        ...
        URLSession.shared.dataTask(with: url) { (data, response, error) in
            ...
            do {
                ...
                completionHandler(jsonData.result.results, nil)
    ...
    // Fetch parkFeature with parkName
    ...
    // Fetch park facility with parkname
